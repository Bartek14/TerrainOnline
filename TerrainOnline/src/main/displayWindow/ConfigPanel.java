...
public class ConfigPanel extends JPanel {
    ...
    JMenu databaseMenu;
    JMenuItem databaseSaveItem;
    JMenuItem databaseLoadItem;
    //JMenuItem databaseDropItem;
	
    JMenu interpolationMenu;
	JMenuItem linearInterpolationItem;
	JMenuItem trigonometricInterpolationItem;
    ...
    public ConfigPanel(Params p) {
	 ...
	 newMenuItem = new JMenuItem("New");
   	 ...
   	 databaseMenu = new JMenu("Database");
   	 	databaseMenu.setActionCommand("DATA");
   	 	databaseMenu.addActionListener(new ConfigurationListener(this));
   	 databaseSaveItem = new JMenuItem("Save in database");
   	 	databaseSaveItem.setActionCommand("DB_SAVE");
   	 	databaseSaveItem.addActionListener(new ConfigurationListener(this));
     databaseLoadItem = new JMenuItem("Load from database");
    	databaseLoadItem.setActionCommand("DB_LOAD");
    	databaseLoadItem.addActionListener(new ConfigurationListener(this));
	 ...
	 linearInterpolationItem = new JMenuItem("Linear");
	    linearInterpolationItem.setActionCommand("LINEAR");
   	    linearInterpolationItem.addActionListener(new ConfigurationListener(this));
	 trigonometricInterpolationItem = new JMenuItem("Trigonometric");
	    trigonometricInterpolationItem.setActionCommand("TRIGONOMETRIC");
   	    trigonometricInterpolationItem.addActionListener(new ConfigurationListener(this));
	    
	        mainMenu.add(saveMenuItem);
	        mainMenu.add(openMenuItem);
	        mainMenu.add(newMenuItem);
	        
	        databaseMenu.add(databaseSaveItem);
	        databaseMenu.add(databaseLoadItem);
	        databaseMenu.addSeparator();
	        mainMenu.add(databaseMenu);
	        
	    	interpolationMenu.add(linearInterpolationItem);
	    	interpolationMenu.add(trigonometricInterpolationItem);
